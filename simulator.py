...
def main():
	algorithms = ("weighted-RR theta-diff optimization SRTF SQF SQF-plus FRF equal-thetas equal-thetas-SQF " + \
		"optim-SQF FRF-EWMA predictive 2RC RR random theta-diff-plus ctl-simplify equal-thetas-fast").split()
