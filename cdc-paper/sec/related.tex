...
% CK: this paragraph starts with centralized vs. distributed, then
% describes our approach. I feel it does not bring too much into the
% discussion.  In general, load-balancing strategies can be either
% centralized or distributed. A centralized solution is composed of a
% single load-balancer that distributes the incoming load to a set of
...
% infrastructure is modified both by the action of the load-balancer
% and by the effect of the self-adaptivity introduced in cloud
% applications.
...
% CK: Erik proposed "proactive" instead of "predictive" as it sounds
% stronger.  I have no preference. :) 
% MM: Predictive is how they describe it here:
% https://devcentral.f5.com/articles/
% intro-to-load-balancing-for-developers-ndash-the-algorithms 
% so I feel we should not change it.
A merge of the fastest replica and the pending request count approach
