...
As given by the brownout paradigm, a replica $i$ responds to requests
...
% CK: We are actually starting to give a solution to the
% load-balancing problem here. I know this part is necessary to
% formulate a problem from the control perspective, but maybe we
% should consider moving it into the solution section or having a
% separate subsection.  
% MM: I am not sure about the title but I am in favor of a subsection
% here :).
