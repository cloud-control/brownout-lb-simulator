...
\str{Todo: move queueing theory stuff and service rate things elsewhere? Insert motivations and expand existing ones. Add more in stationarity and issues with that.}
