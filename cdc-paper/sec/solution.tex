...
amount of optional content served decreases, the replica will receive
less traffic, to increase the control variable if possible.
...
the service time of requests with and without optional content $M_i$
and $\mu_i$ that might not be available and could require additional
computation to be estimated correctly. 

\str{Add or remove? Also, this solution is unlikely to scale when the
