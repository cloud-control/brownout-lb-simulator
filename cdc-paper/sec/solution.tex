...
$\theta_i$ and reacts correspondingly. If the percentage of optional
...
decrease its load and allow $\theta_i$ to increase.
...
powerful replica is receiving more traffic with respect to the least powerful
