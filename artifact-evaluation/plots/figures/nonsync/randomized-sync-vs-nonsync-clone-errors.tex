...
table [x index=0, y index=2, x error index=1, y error index=3] {data/randomized-sync-vs-nonsync/randomized_sqf_clone_confint-v2.txt};
...
table [x index=0, y index=2, x error index=1, y error index=3] {data/randomized-sync-vs-nonsync/randomized_random_clone_confint-v2.txt};
