...
\str{{\bf Martina}: In the simulator we have some load balancing
  strategies: (1) a weighed round robin called \emph{static}. 
  (2) the fastest replica (SRF, shortest replica first). 
  (3) the connection count (SQF, shortest queue first). 
  We should also implement: (4) the predictive approach.}
