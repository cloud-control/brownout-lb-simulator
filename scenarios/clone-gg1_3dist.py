...
s1dist.random_state = np.random.RandomState(seed=1*3+45567)

s2dist = stats.uniform(loc=0.5, scale=3)
s2dist.random_state = np.random.RandomState(seed=2*3+45567)

s3dist = stats.weibull_min(3, scale=2)
s3dist.random_state = np.random.RandomState(seed=3*3+45567)
